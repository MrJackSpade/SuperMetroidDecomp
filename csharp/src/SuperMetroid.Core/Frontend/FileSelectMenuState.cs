...
/// <summary>
/// Cartridge-backed implementation of the fresh-save file-select path at
/// <c>$81:944E-$81:A32A</c>.
/// </summary>
/// <remarks>
...
/// border, helmets, and selection missile all come from the supplied retail ROM. Existing
/// SRAM validation is a separate milestone; until it is ported the address space starts with
/// the same three empty slots as a cleared cartridge.
/// </remarks>
public sealed class FileSelectMenuState
{
    ...
    public void Step(ushort controllerInput)
    {
        ...
        switch (Phase)
        {
            ...
            case FileSelectPhase.Main:
                // With no nonempty files, `$81:A1C2` skips Copy/Clear. Up and Down cycle
                // through A, B, C, and Exit in the exact order encoded by the assembly.
    ...
    private void BuildFreshSaveTilemap()
    {
