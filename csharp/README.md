...
dotnet run --no-launch-profile --project src/SuperMetroid.DebugRunner -- "../Super Metroid.smc" --frames 1750 --mother-brain-rainbow-script --output ../standalone-assets/runtime/MotherBrainFinalBeamFrame.png
```
