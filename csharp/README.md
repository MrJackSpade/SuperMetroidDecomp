...
- bank-$90/$93/$94 uncharged power beams: five ordinary slots, all ten muzzle directions,
  shared shot/bomb cooldown, signed 8.8 velocity and acceleration, terrain impact, cartridge
  animation/explosion lists, alternating-frame OAM, and exact beam-tile/palette upload
...
The same held input now fires live uncharged power beams through the five-slot producer,
...
all four Samus firing milestones. A 12-frame PNG freezes a travelling projectile, while the
...
grapple, Crystal Flash, X-ray, drained/Draygon, liquid/atmospheric/landing-impact, and documented
...
Brain attack selection, live Hyper Beam damage routing, charged/combined beam and missile/super/
