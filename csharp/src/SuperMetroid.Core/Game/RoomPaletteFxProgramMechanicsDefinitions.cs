...
public static class RoomPaletteFxProgramMechanicsDefinitions
{
    ...
    {
        if (PaletteFxDeleteProgramMechanicsDefinitions.TryReadMechanicsWord(
                pointer,
                out value))
        {
            return true;
        ...
        if (ZebesExplosionFinalePaletteFxProgramMechanicsDefinitions.TryReadMechanicsWord(
                pointer,
                out value))
        {
            return true;
        }
        if (ZebesExplosionWhiteoutPaletteFxProgramMechanicsDefinitions.TryReadMechanicsWord(
                pointer,
                out value))
        {
            return true;
        }
        if (ZebesExplosionAmbientPaletteFxProgramMechanicsDefinitions.TryReadMechanicsWord(
                pointer,
                out value))
        {
            return true;
        }
        if (ZebesExplosionLayerFadePaletteFxProgramMechanicsDefinitions.TryReadMechanicsWord(
                pointer,
                out value))
        {
            return true;
        }
        if (ZebesExplosionGunshipPaletteFxProgramMechanicsDefinitions.TryReadMechanicsWord(
                pointer,
                out value))
        {
            return true;
        ...
        if (PostCreditsIconGlarePaletteFxProgramMechanicsDefinitions.TryReadMechanicsWord(
                pointer,
                out value))
        {
            return true;
