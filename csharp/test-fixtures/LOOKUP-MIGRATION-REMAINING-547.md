...
| Kraid hitboxes/projectiles | `KraidCollisions`, `KraidNails`: indirect mouth hitboxes, BF1D nail offsets and BE3E/BE46 indirect velocity choices | Inspect overlapping record strides, signed coordinates and actual collision/placement paths. BC65 spat-rock velocities and B163/B165 body contour are now compiled. |
