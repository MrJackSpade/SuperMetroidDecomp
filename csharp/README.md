...
dotnet run --no-launch-profile --project src/SuperMetroid.DebugRunner -- "../Super Metroid.smc" --frames 4791 --mother-brain-rainbow-script --output ../standalone-assets/runtime/MotherBrainBabyHealingFrame.png
```
