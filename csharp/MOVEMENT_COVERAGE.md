...
| `$14` | Wall jumping | `$83/$84`, air/water/lava normal/Hi-Jump launch tables, variable height, submerged `$FB` selection, spin handoff, table-driven aim/Shot exits to normal-jump `$69-$6C/$13/$14`, terrain/solid-enemy launch and landing, ordinary/grapple launch sounds, charged frames 3-22 contact damage and frame-23+ Screw-style damage | Live enemy actor/shake consumer |
...
- The bank-$91 collision command installs `$83/$84`, clears old momentum, and reads air,
  ...
  reuses ordinary jumping physics. Its literal `$91:A9EC/$AA12` tables route aim and Shot to
  `$69-$6C/$13/$14` through the shared pose-expansion/normal-jump initializer while preserving
  live velocity and restoring the normal suit palette after Screw contact art. Animation
  command `$FB` selects ordinary, Space Jump, or
