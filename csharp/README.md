...
The 160-frame assertion requires all four firing milestones; the running, jumping, falling,
and landing PNGs freeze their authentic private-ROM tile definitions against live BG layers.
...
producers, projectile-triggered shootable/special-block PLMs, live enemy damage producers, solid-enemy wall-jump branches,
