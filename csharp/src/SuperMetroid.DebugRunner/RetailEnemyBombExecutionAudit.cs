...
internal static partial class RetailEnemyExecutionAudit
{
        ...
        RoomEnemySlot target)
    {
        ...
        return (target.EnemyDefinitionPointer, target.Definition.Bank, callback) switch
        {
            ...
            (0xd03f, 0xa2, 0xa579) => NormalBombAuditBehavior.FocusedOnly,
            ...
            (0xe2bf, 0xa7, 0x804c) => NormalBombAuditBehavior.FocusedOnly,
            (0xe2ff, 0xa7, 0x94b5) => NormalBombAuditBehavior.FocusedOnly,
            (0xe3ff, 0xa7, 0x94b5) => NormalBombAuditBehavior.FocusedOnly,
            (0xe4bf, 0xa7, 0xdd9b) => NormalBombAuditBehavior.FocusedOnly,
            (0xe4ff, 0xa7, 0x804c) => NormalBombAuditBehavior.FocusedOnly,
            (0xe53f, 0xa7, 0x804c) => NormalBombAuditBehavior.FocusedOnly,
            (0xe57f, 0xa7, 0x804c) => NormalBombAuditBehavior.FocusedOnly,
            (0xec3f, 0xa9, 0xb507) => NormalBombAuditBehavior.FocusedOnly,
            (0xec7f, 0xa9, 0xb503) => NormalBombAuditBehavior.FocusedOnly,
            (0xeebf, 0xa9, 0xf842) => NormalBombAuditBehavior.FocusedOnly,
            (0xeeff, 0xaa, 0xc97c) => NormalBombAuditBehavior.FocusedOnly,
            (0xef7f, 0xaa, 0xd667) => NormalBombAuditBehavior.FocusedOnly,
            (0xf07f, 0xaa, 0xdf34) => NormalBombAuditBehavior.FocusedOnly,
