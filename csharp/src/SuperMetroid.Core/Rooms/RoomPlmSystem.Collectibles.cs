...
public sealed partial class RoomPlmSystem
{
    ...
    {
        InWorldCollectibleKind.EnergyTank => 0x01,
        InWorldCollectibleKind.MissileTank => 0x02,
        InWorldCollectibleKind.SuperMissileTank => 0x03,
        InWorldCollectibleKind.PowerBombTank => 0x04,
        InWorldCollectibleKind.GrappleBeam => 0x05,
        InWorldCollectibleKind.XrayScope => 0x06,
        InWorldCollectibleKind.VariaSuit => 0x07,
        InWorldCollectibleKind.SpringBall => 0x08,
        InWorldCollectibleKind.MorphBall => 0x09,
        InWorldCollectibleKind.ScrewAttack => 0x0a,
        InWorldCollectibleKind.HiJumpBoots => 0x0b,
        InWorldCollectibleKind.SpaceJump => 0x0c,
        InWorldCollectibleKind.SpeedBooster => 0x0d,
        InWorldCollectibleKind.ChargeBeam => 0x0e,
        InWorldCollectibleKind.IceBeam => 0x0f,
        InWorldCollectibleKind.WaveBeam => 0x10,
        InWorldCollectibleKind.SpazerBeam => 0x11,
        InWorldCollectibleKind.PlasmaBeam => 0x12,
        InWorldCollectibleKind.Bombs => 0x13,
        InWorldCollectibleKind.GravitySuit => 0x14,
        InWorldCollectibleKind.ReserveTank => 0x19,
