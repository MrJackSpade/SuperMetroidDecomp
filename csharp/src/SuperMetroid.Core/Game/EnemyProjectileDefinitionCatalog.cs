...
internal static class EnemyProjectileDefinitionCatalog
{
    ...
    internal static EnemyProjectileDefinition Get(RoomEnemyProjectileKind kind) => kind switch
    {
        ...
        RoomEnemyProjectileKind.KraidSpitRock => new(0x9CA3, 0x9D56, 0x9C7D, 0x0404, 0x8002, 0x0000, 0x9C89),
        RoomEnemyProjectileKind.KraidCeilingRock => new(0x9CD8, 0x9D89, 0x9C7D, 0x0404, 0xA000, 0x0000, 0x84FC),
        RoomEnemyProjectileKind.KraidRisingRockLeft => new(0x9D0C, 0x9D56, 0x9C7D, 0x0404, 0xA000, 0x0000, 0x84FC),
        RoomEnemyProjectileKind.KraidRisingRockRight => new(0x9D0C, 0x9D56, 0x9C83, 0x0404, 0xA000, 0x0000, 0x84FC),
        ...
        RoomEnemyProjectileKind.AlcoonFireball => new(0x9EB2, 0x9EFF, 0x9E9E, 0x0404, 0x0014, 0x0000, 0x84FC),
        ...
        RoomEnemyProjectileKind.FakeKraidSpit => new(0x9DEC, 0x9E1E, 0x9DDA, 0x0404, 0x0014, 0x0000, 0x84FC),
        RoomEnemyProjectileKind.FakeKraidSpikeLeft => new(0x9E46, 0x9E83, 0x9DE0, 0x0204, 0x0006, 0x0000, 0x84FC),
        RoomEnemyProjectileKind.FakeKraidSpikeRight => new(0x9E4B, 0x9E83, 0x9DE6, 0x0204, 0x0006, 0x0000, 0x84FC),
        ...
        RoomEnemyProjectileKind.DragonFireball => new(0xB4EF, 0xB535, 0xB4BF, 0x0202, 0x000A, 0x0000, 0x84FC),
        RoomEnemyProjectileKind.EyeDoorProjectile => new(0xB62D, 0x84FB, 0xB5D9, 0x0808, 0x8004, 0x0000, 0xB603),
        RoomEnemyProjectileKind.EyeDoorSweat => new(0xB683, 0xB714, 0xB615, 0x0000, 0x0004, 0x0000, 0x84FC),
        ...
        RoomEnemyProjectileKind.KagoBug => new(0xD088, 0xD0EB, 0x9C7D, 0x0404, 0x0014, 0x0000, 0xD064),
