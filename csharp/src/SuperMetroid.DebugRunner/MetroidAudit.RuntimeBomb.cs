...
internal static partial class MetroidAudit
{
    public static int VerifyRuntimePlacedBomb(string romPath)
    {
        ...
        for (int x = 0; x < level.WidthInBlocks; x++)
        {
            ...
            level.SetForegroundEntry(index, y >= 14 ? (ushort)0x8000 : (ushort)0);
        ...
        samus.YPosition = (ushort)(224 - samus.Kinematics.YRadius);
        ...
        if (attached < 0 || placed < 0 || detached < 0)
            throw new InvalidDataException($"Runtime bomb detachment failed: attached={attached}, placed={placed}, detached={detached}, pose={samus.Pose:X2}, Y={samus.YPosition}.");
