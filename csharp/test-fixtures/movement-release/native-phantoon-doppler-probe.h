...
int DiagnosticPhantoonDoppler(const char *rom, const char *output) {
  ...
  for (int start = 1640; start <= 1660; start += 10)
  for (int cadence = 8; cadence <= 12; cadence++)
  for (int aerial = 0; aerial < 2; aerial++) {
