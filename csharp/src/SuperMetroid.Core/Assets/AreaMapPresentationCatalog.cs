...
public static class AreaMapCatalogFormat
{
    ...
    /// <summary>Manifest-bound non-area artwork files, including the three normal suit palettes.</summary>
    public const int SharedResourceCount = 55;
