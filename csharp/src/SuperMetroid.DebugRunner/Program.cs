...
if (args.Length == 4 && args[0] == "--gate-glitch-room-audit")
    return GateGlitchRoomAudit.Run(args[1], byte.Parse(args[2]), args[3]);
if (args.Length == 3 && args[0] == "--gate-glitch-jump-audit")
...
if (args.Length == 6 && args[0] == "--gate-glitch-jump-audit")
    return GateGlitchRoomAudit.RunJump(args[1], int.Parse(args[2]), int.Parse(args[3]), bool.Parse(args[4]), bool.Parse(args[5]));
...
if (args.Length == 2 && args[0] == "--ceiling-wrap-room-audit")
    return CeilingWrapRoomAudit.Run(args[1]);
if (args.Length == 3 && args[0] == "--ceiling-wrap-room-audit")
    return CeilingWrapRoomAudit.Run(args[1], ushort.Parse(args[2]));
...
if (args.Length is 2 or 3 or 4 && args[0] == "--noob-tube-control-audit")
    return NoobTubeControlAudit.Run(args[1], args.Length >= 3 ? args[2] : null, args.Length == 4 ? int.Parse(args[3]) : 124);
...
if (args.Length is 2 or 3 && args[0] == "--phantoon-return-position-audit")
    return PhantoonDopplerAudit.Run(args[1], args.Length == 3 ? args[2] : null, returnPositionControls: true);
...
if (args.Length is 2 or 3 && args[0] == "--phantoon-fired-plasma-audit")
    return PhantoonFiredPlasmaAudit.RunControls(args[1], args.Length == 3 ? args[2] : null);
...
if (args.Length == 3 && args[0] == "--gravity-jump-comparison-audit")
    return GravityJumpComparisonAudit.Run(args[1], args[2]);
...
if (args.Length == 3 && args[0] == "--vertical-speed-audit")
    return VerticalSpeedComparisonAudit.Run(args[1], args[2]);
...
if (args.Length == 3 && args[0] == "--ceres-engine-glow-audit")
    return CeresEngineGlowAudit.Run(args[1], args[2]);
if (args.Length == 3 && args[0] == "--options-cursor-audit")
    return OptionsCursorAudit.Run(args[1], args[2]);
...
if (args.Length == 3 && args[0] == "--xray-climb-timing-audit")
    return XrayClimbTimingAudit.Run(args[1], args[2]);
...
if (args.Length == 3 && args[0] == "--crystal-spark-audit")
    return TemporaryBlueSuitComparisonAudit.Run(args[1], args[2], TemporaryBlueAuditKind.CrystalSpark);
if (args.Length == 3 && args[0] == "--crystal-heights-audit")
    return TemporaryBlueSuitComparisonAudit.Run(args[1], args[2], TemporaryBlueAuditKind.CrystalHeights);
if (args.Length == 3 && args[0] == "--suit-spark-audit")
...
if (args.Length == 3 && args[0] == "--draygon-crystal-edges-audit")
    return DraygonCrystalEdgesAudit.Run(args[1], args[2]);
if (args.Length == 3 && args[0] == "--draygon-crystal-refill-audit")
...
if (args.Length == 3 && args[0] == "--flash-lifetime-audit")
...
if (args.Length == 3 && args[0] == "--flash-beam-audit")
...
if (args.Length == 3 && args[0] == "--flash-suit-flow-audit")
    return FlashSuitFlowAudit.Run(args[1], args[2]);
if (args.Length == 3 && args[0] == "--flash-suit-fuse-audit")
...
if (args.Length >= 2 && args[0] is "--map-station-pause-gate-audit" or "--map-station-controls-audit")
{
    string mapStationRomPath = string.Join(' ', args[1..]).Trim('"');
    return args[0] == "--map-station-controls-audit"
        ? MapStationPauseGateAudit.RunLockedControls(mapStationRomPath)
        : MapStationPauseGateAudit.Run(mapStationRomPath);
}
...
if (args.Length == 2 && args[0] == "--zebetite-player-repeat-audit")
    return ZebetiteRepeatedPlayerAudit.Run(args[1]);
if (args.Length == 2 && args[0] == "--zebetite-player-second-search")
    return ZebetiteRepeatedPlayerAudit.SearchSecondShot(args[1]);
if (args.Length == 2 && args[0] == "--zebetite-player-return-search")
    return ZebetiteReturnHopAudit.Run(args[1]);
if (args.Length == 2 && args[0] == "--zebetite-player-second-hit-search")
    return ZebetiteSecondHitAudit.Search(args[1]);
if (args.Length == 2 && args[0] == "--zebetite-player-second-hit-audit")
    return ZebetiteSecondHitAudit.Search(args[1], focused: true);
if (args.Length == 3 && args[0] == "--zebetite-player-second-hit-export")
    return ZebetiteSecondHitAudit.Search(args[1], focused: true, exportDirectory: args[2]);
if (args.Length == 2 && args[0] == "--zebetite-player-third-hit-search")
    return ZebetiteThirdHitAudit.Search(args[1]);
if (args.Length == 2 && args[0] == "--zebetite-player-third-hit-audit")
...
if (args.Length == 4 && args[0] == "--zebetite-player-double-search")
    return ZebetiteDoubleControllerAudit.Search(args[1], args[2], args[3]);
if (args.Length == 4 && args[0] == "--zebetite-player-double-audit")
    return ZebetiteDoubleControllerAudit.Verify(args[1], args[2], args[3]);
...
if (args.Length >= 2 && args[0] == "--botwoon-x-plasma-fired")
    return BotwoonAudit.RunFiredXPlasma(args[1], args.Length > 2 ? args[2] : null);
if (args.Length >= 2 && args[0] == "--botwoon-hyper-audit")
    return BotwoonAudit.RunHyper(args[1], args.Length > 2 ? args[2] : null);
...
if (args.Length == 3 && args[0] == "--golden-distance-native-compare")
    return GoldenTorizoAudit.CompareNativeDistanceDecisions(args[1], args[2]);
...
if (args.Length == 3 && args[0] == "--golden-ammo-native-compare")
    return GoldenTorizoAudit.CompareNativeAmmoDecisions(args[1], args[2]);
...
if (args.Length == 3 && args[0] == "--golden-eye-release-native-compare")
    return GoldenTorizoAudit.CompareNativeLifecycle(args[1], args[2], releaseEyeBeams: true);

if (args.Length == 3 && args[0] == "--golden-super-lifecycle-native-compare")
    return GoldenTorizoAudit.CompareNativeLifecycle(args[1], args[2], superMissiles: true);
...
if (args.Length is 2 or 3 && args[0] == "--golden-encounter-contact")
    return GoldenTorizoAudit.TraceEncounter(args[1], args.Length == 3 ? args[2] : null, detailed: true, contact: true);
