...
Status: contact defects reproduced and corrected. #470 is ready for player validation;
the conversion dependency is covered by [TEMPORARY-BLUE.md](TEMPORARY-BLUE.md).
