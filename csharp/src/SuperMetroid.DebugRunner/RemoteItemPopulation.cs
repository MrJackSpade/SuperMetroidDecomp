...
internal sealed class RemoteItemPopulation(ISnesAddressSpace inner, byte column) : ISnesAddressSpace
{
    public byte ReadByte(int address)
    {
        ...
        ReadOnlySpan<byte> population = [(byte)(RoomPlmHeaders.ExposedMissileTank & 255),
            (byte)(RoomPlmHeaders.ExposedMissileTank >> 8), column, 8, 0, 0, 0, 0];
