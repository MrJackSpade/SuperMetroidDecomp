...
internal static partial class Program
{
    private static void VerifyEnemyTileArtwork()
    {
        ...
        try
        {
            ...
            VerifyInstalledBotwoonColors(bus, directory, stock);
            VerifyInstalledMotherBrainDeathColors(bus, directory, stock);
        ...
        Console.WriteLine("  Enemy artwork: 122 retail tile/color sheets, Crocomire melts, Kraid body/head maps, backdrop PNG, palette effects and four HUD-derived death restores, plus Boyon/Cacatac/Boulder/Atomic/Skultera/Waver/Skree/Metaree/Zoa/Pipe Bug/Fake Kraid/Kraid nail/Owtch/Stoke/Ripper/Fireflea/Magdollite/Ceres door/Ceres Baby visual frames pass stock parity, live edits, persistence, and invalid-resource checks.");
    }
}
