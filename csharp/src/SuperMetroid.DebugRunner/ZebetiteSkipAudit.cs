...
internal static class ZebetiteSkipAudit
{
    ...
    private static void RunCase(string romPath, int stepBackFrames, string? exportPrefix = null, bool isolate = false, bool repeatStepBack = false)
    {
        ...
        Console.WriteLine($"CASE stepBackFrames={stepBackFrames} repeatStepBack={repeatStepBack}");
