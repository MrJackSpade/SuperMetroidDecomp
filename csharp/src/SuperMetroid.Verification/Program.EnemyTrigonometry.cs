...
internal static partial class Program
{
    private static void VerifyCompiledEnemyTrigonometry()
    {
        ...
        VerifySpacePirateProjectileInstructionProgramDefinitions(rom);
        ...
        VerifyTourianStatueProjectileInstructionProgramDefinitions(rom);
        VerifySporeSpawnProjectileInstructionProgramDefinitions(rom);
        VerifyBotwoonProjectileInstructionProgramDefinitions(rom);
        ...
        VerifyTorizoChozoOrbInstructionProgramDefinitions(rom);
        VerifyTorizoSonicBoomInstructionProgramDefinitions(rom);
        VerifyBombTorizoStatueInstructionProgramDefinitions(rom);
        VerifyGoldenTorizoEggInstructionProgramDefinitions(rom);
        ...
        VerifyGunshipInstructionProgramDefinitions(rom);
        VerifyRidleyInstructionProgramDefinitions();
        VerifyDraygonInstructionProgramDefinitions();
        VerifyWalkingSpacePirateInstructionProgramDefinitions(rom);
        ...
        VerifyMotherBrainTurretInstructionProgramDefinitions(rom);
        ...
        VerifyGrowingShutterInstructionProgramDefinitions(rom);
        ...
        VerifyWreckedShipGhostInstructionProgramDefinitions(rom);
        VerifyPuyoInstructionProgramDefinitions(rom);
        ...
        VerifyRioInstructionProgramDefinitions(rom);
        ...
        VerifyMetroidInstructionProgramDefinitions(rom);
        VerifyNorfairRioInstructionProgramDefinitions(rom);
        VerifyLowerNorfairRioInstructionProgramDefinitions(rom);
        ...
        VerifyKraidLintInstructionProgramDefinitions(rom);
        VerifyPhantoonInstructionProgramDefinitions(rom);
        VerifyWorkRobotInstructionProgramDefinitions(rom);
        VerifyYardInstructionProgramDefinitions(rom);
        ...
        VerifyBotwoonInstructionProgramDefinitions(rom);
        ...
        VerifyWaverInstructionProgramDefinitions(rom);
        ...
        VerifyCeresSteamInstructionProgramDefinitions(rom);
        VerifyCeresDoorInstructionProgramDefinitions(rom);
        ...
        VerifyEscapeDachoraInstructionProgramDefinitions(rom);
        ...
        VerifyDeadTorizoCorpseDefinitions(rom);
        ...
        VerifyGrappleConnectionDefinitions(rom);
        ...
        VerifyProjectileFrameBindings(rom);
