...
int main(int argc, char **argv) {
  ...
  if (argc != 2 && !full && !edges && !refill && !suit_entry && !suit_flow && !elevator_entry && !suit_fuse && !spike_suit && !spike_suit_reserve && !reserve_mode && !cinematic_flash && !forced_blue) return 2;
