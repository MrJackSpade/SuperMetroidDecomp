...
internal static class EnemyProjectileDefinitionCatalog
{
    ...
    internal static EnemyProjectileDefinition Get(RoomEnemyProjectileKind kind) => kind switch
    {
        ...
        RoomEnemyProjectileKind.FallingSpark => new(0xF391, 0xF3F0, 0xF353, 0x0404, 0x0005, 0x0000, 0x84FC),
        ...
        RoomEnemyProjectileKind.NamiheFireball => new(0xDED6, 0xDF39, 0xDE96, 0x0804, 0x00C8, 0x0000, 0x84FC),
        RoomEnemyProjectileKind.FuneFireball => new(0xDED6, 0xDF39, 0xDE96, 0x0804, 0x003C, 0x0000, 0x84FC),
        RoomEnemyProjectileKind.LavaThrownByMagdollite => new(0xE000, 0xE049, 0xDFD8, 0x0202, 0x8028, 0x0000, 0xDFE4),
