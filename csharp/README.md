...
capture/render the two visible trailing bodies. Post-cancel echo departure, stored shine,
and shinespark remain separate follow-up systems. Useful breakpoints are
