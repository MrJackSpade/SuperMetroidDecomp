/// <summary>Native WRAM identities used only to import the Snes9x #445 movement fixture.</summary>
internal static class MoatMovieMemory
{
    ...
    /// <summary>$D870: persistent collected-item bits, including the Moat missile.</summary>
