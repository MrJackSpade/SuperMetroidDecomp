...
{
    public static int Run(string rom, string inputPath, string tracePath)
    {
        ...
        for (int left = 0; left < 2; left++)
        {
            ...
            int launches = 0, floorContacts = 0, ceilingContacts = 0;
            ...
            if (launches != 22 || floorContacts != 0 || ceilingContacts != 18 ||
